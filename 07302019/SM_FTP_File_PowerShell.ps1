...
Get-Content $SM_IICS_Src_Path\UM_DATA.txt  | Foreach {$_.TrimEnd('|')}  | Set-Content "$SM_IICS_Src_Path\UM_DATA_File.txt"
Get-Content $SM_IICS_Src_Path\UM_DATES.txt  | Foreach {$_.TrimEnd('|')}  | Set-Content "$SM_IICS_Src_Path\UM_DATES_File.txt"
Get-Content $SM_IICS_Src_Path\UM_Hours.txt  | Foreach {$_.TrimEnd('|')}  | Set-Content "$SM_IICS_Src_Path\UM_Hours_File.txt"
Get-Content $SM_IICS_Src_Path\UM_Ops_Hieararchy.txt  | Foreach {$_.TrimEnd('|')}  | Set-Content "$SM_IICS_Src_Path\UM_Hieararchy_File.txt"
Get-Content $SM_IICS_Src_Path\UM_Ops_Hieararchy_Descr_File.txt  | Foreach {$_.TrimEnd('|')}  | Set-Content "$SM_IICS_Src_Path\UM_Hieararchy_Descr_File.txt"
Get-Content $SM_IICS_Src_Path\UM_ATTRIBUTES.txt  | Foreach {$_.TrimEnd('|')}  | Set-Content "$SM_IICS_Src_Path\UM_ATTRIBUTES_File.txt"
